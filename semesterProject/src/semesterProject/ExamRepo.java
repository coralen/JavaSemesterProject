...
public class ExamRepo {
	...
	public void addQuestion(String questionString, int questionType, Level questionLevel) {
		Question questionToAdd;
		if (questionType == 1) {
			questionToAdd = new MultiChoiceQuestion(questionString, questionLevel);
			
		} else {
			questionToAdd = new OpenQuestion(questionString, questionLevel);
		}
	...
	public void addMultiChoiceAnswer(int questionIndex, String answer, boolean answerType) { // We need the type of
																								// question
	...
	public void createQuestions() {
		...
		answers[1] = ans2;
		answers[2] = ans3;
		MultiChoiceQuestion qst1 = new MultiChoiceQuestion("Which is the largest planet in the solar system?", answers,
				Level.HIGH);
		...
		answers2[1] = ans2;
		answers2[2] = ans3;
		MultiChoiceQuestion qst2 = new MultiChoiceQuestion("which is the world’s largest ocean?", answers2,
				Level.MEDIUM);

		OpenQuestion qst3 = new OpenQuestion("Who was the first presidente of the USA?", "George Washington",
				Level.LOW);
